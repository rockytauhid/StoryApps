package com.rockytauhid.storyapps.view.camera
...
import com.rockytauhid.storyapps.databinding.ActivityCameraBinding
import com.rockytauhid.storyapps.helper.createFile
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({
            ...
            try {
                ...
                Log.e(TAG, "onFailure: ${exc.message}")
            }
        }, ContextCompat.getMainExecutor(this))
    }
